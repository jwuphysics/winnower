...
class TestCLI:
    ...
    def test_setup_command(self):
        ...
        with patch('winnower.cli.setup_user_env') as mock_setup, \
             patch('winnower.cli.check_api_keys') as mock_check:
    ...
    def test_main_exception_handling(self):
        ...
        with patch('winnower.cli.load_config', side_effect=Exception("Test error")):
            result = main(["dummy_input"])
            assert result == 1