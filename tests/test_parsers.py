...
class TestPaperParser:
    ...
    def test_extract_arxiv_id_from_url(self):
        ...
        assert self.parser._extract_arxiv_id_from_url("https://arxiv.org/abs/2301.00001") == "2301.00001"
        assert self.parser._extract_arxiv_id_from_url("https://arxiv.org/pdf/1234.5678") == "1234.5678"
    ...
    def test_parse_arxiv_mock(self, mock_search):
        ...
        with patch.object(self.parser, '_extract_pdf_text', return_value="Test content"):
